...
## How do I delete a message from a list archive?
...
1. Login at lists.riseup.net.
1. Click archives.
1. Navigate to the message that you want to delete. Click on it to display it.
1. Click the "tag this mail for deletion" button.
