...
h2. Wichtige Funktionen, nach denen eine Beurteilung des Clients erfolgen kann:
...
| *[[Jingle -> https://en.wikipedia.org/wiki/Jingle_(protocol)]]?* | Falls verfügbar, kann dieser Client für Sprach- und Videochat verwendet werden. |
...
h2. Empfohlene Clients

table(table table-striped).
|_. Client |_. Unterstütztes Betriebssystem |_. OTR? |_. OMEMO? |_. Jingle? |_. Proxy? |_. TLS? |_. Tor? |_. MUC? |_. Kommentare |
...
table(table table-striped).
|_. Client |_. Unterstützte Betriebssysteme |_. OTR? |_. OMEMO? |_. Jingle? |_. Proxy? |_. TLS? |_. Tor? |_. MUC? |_. Kommentare |
...
table(table table-striped).
|_. Client |_. OS supportés |_. OTR? |_. OMEMO? |_. Jingle? |_. Proxy? |_. SSL/TLS? |_. Tor? |_. MUC? |_. Kommentare |
