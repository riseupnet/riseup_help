...
h2. Riseup's XMPP Dienst verwenden
...
h2. Verbindung mit multi-user Chatrooms (Gruppenchats) herstellen
...
h2. Für höhere Sicherheit

# Um deine Sicherheit zu erhöhen, verbinde dich mit unserem XMPP-Server über das [[Riseup VPN => vpn]].
# Benutze unseren "Tor .onion-Dienst":https://www.torproject.org/docs/hidden-services.html.en: suche nach @xmpp.*.onion@ auf der Seite mit [[Riseups onion-Diensten->tor#riseups-tor-hidden-services]].
