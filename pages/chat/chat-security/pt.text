...
Para assegurar a criptografia ponta a ponta das mensagens, a melhor opção é o protocolo [[Off-the-Record Messaging (ORT) -> https://pt.wikipedia.org/wiki/Off-the-Record_Messaging]]. Para mais informações, leia nosso [[tutorial sobre OTR -> otr]].

h2. Chamadas seguras

Da última vez que checamos, Jitsi era o único cliente de XMPP que oferecia ligações de voz e vídeo seguras.

h2. Use IRC com segurança
